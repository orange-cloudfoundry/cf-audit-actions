...
require (
	...
	github.com/cloudfoundry-community/go-cf-clients-helper/v2 v2.12.1
...
require (
	...
	code.cloudfoundry.org/cli/v8 v8.17.0 // indirect
	...
	github.com/cloudfoundry/bosh-utils v0.0.573 // indirect
